...
import {GlowGuardedLaunchV2} from "@/GuardedLaunchV2/Glow.GuardedLaunchV2.sol";
import {UnifapV2Library} from "@unifapv2/libraries/UnifapV2Library.sol";
import {_GENESIS_TIMESTAMP} from "@/Constants/Constants.sol";

contract TestGLOWGuardedLaunchV2 is GlowGuardedLaunchV2 {
    ...
    constructor(
        ...
        GlowGuardedLaunchV2(
            ...
            _gccContract,
            new address[](0),
            abi.encode(address(0xffffaaff11), block.timestamp, block.timestamp, block.timestamp, block.timestamp)
        )
    {
