...
deploy.seed.sepolia :; forge script script/Sepolia/Seed.t.sol --rpc-url ${SEPOLIA_RPC_URL} --broadcast -vvvv --private-key ${SEPOLIA_PRIVATE_KEY} \
--etherscan-api-key ${ETHERSCAN_API_KEY} --verify --retries 10 --delay 10
