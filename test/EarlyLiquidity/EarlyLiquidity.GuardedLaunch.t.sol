...
//         earlyLiquidity = new EarlyLiquidity(address(usdg), address(holdingContract)); //deployerNonce + 3
//         address precomputedMinerPoolAddress = computeCreateAddress(deployer, deployerNonce + 5);
//         glow = new TestGLOWGuardedLaunch(
//             address(earlyLiquidity),
//             VESTING_CONTRACT,
//             precomputedMinerPoolAddress,
//             VETO_COUNCIL,
//             GRANTS_TREASURY,
//             SIMON,
//             address(usdg),
...
//      */
//     function test_guarded_setGlowTokenTwice_shouldFail() public {
//         test_guarded_setGlowAndMint();
