...
//         address precomputedTreasury = computeCreateAddress(deployer, deployerNonce + 5);
...
//         vetoCouncilContract = new VetoCouncil(address(glow), address(glow), startingAgents); //deployerNonce + 4
//         treasury = new GrantsTreasury(address(glow), address(governance)); //deployerNonce + 5
//         holdingContract = new SafetyDelay(address(vetoCouncilContract), precomputedMinerPool); //deployerNonce + 6
//         gcaAndMinerPoolContract = new MinerPoolAndGCA( //deployerNonce + 7
//             startingAgents,
//             address(glow),
//             address(governance),
//             gcaRequirementsHash,
