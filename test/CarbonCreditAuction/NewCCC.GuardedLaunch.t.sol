...
//         address precomputedMinerPool = computeCreateAddress(deployer, deployNonce + 8);
//         address precomputedVeto = computeCreateAddress(deployer, deployNonce + 6);
...
//         ); //deployNonce + 5
//         vetoCouncil = new VetoCouncil(governance, address(glow), startingAgents); //deployNonce + 6
//         holdingContract = new HoldingContract(address(vetoCouncil)); //deployNonce + 7
