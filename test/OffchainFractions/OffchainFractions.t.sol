...
contract OffchainFractionsTest is Test {
    ...
    function test_error_InsufficientSharesAvailable() public {
        ...
        offchainFractions.buyFractions(
            creator, FRACTION_ID, TOTAL_STEPS + 1, TOTAL_STEPS + 1, address(0), buyer1, false
        ); // minStepsToBuy > available
    }
    ...
    function test_integration_CounterfactualAddress() public {
        ...
        vm.prank(buyer2);
        offchainFractions.buyFractions(
            creator, FRACTION_ID, TOTAL_STEPS - MIN_SHARES, MIN_SHARES, address(0), buyer1, false
        );
